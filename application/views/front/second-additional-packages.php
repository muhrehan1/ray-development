...
<section class="inner-banner package-banner" style="  background: url(<?php echo base_url(); ?>/assets/front/images/USpp4.jpeg); ">
		<div class="container">
			<div class="row">
				<div class="col-12 col-md-12 col-sm-12 col-lg-12 col-xl-12 col-xxl-12">
					<h2>2nd or Additional Passport Services</h2>
				</div>
			</div>
		</div>
		<div class="packages">
		...
		<div class="container">
			<div class="row justify-content-center">
				<div class="col-12 col-md-12 col-sm-12 col-lg-8 col-xl-8 col-xxl-8">
					...
					<div><div class="slider-box">
						<h2>Passport Application Qualifications</h2>
						<div class="slider-box-content">
							<h6>Additional or 2nd US Passport Application</h6>
							<p><strong>Note:</strong> It is <u>not</u> commonly known that the U.S. State Department issues to qualified applicant’s 2nd or additional U.S. passports. They are legally issued under specific circumstances by the Federal government. Normally they are issued for the following two reasons:</p>
							<ol>
							...
							<p><strong>Description:</strong> The following must be true for you to use this method of obtaining a 2ND or Additional US Passport:</p>
							<ol>
				...
				<div><div class="slider-box">
					...
					<div><div class="slider-box">
						...
						<div class="slider-box-content text-center">
							<p>Submit evidence of your International Departure date (flight reservations) showing at least 2 separate flights which validate and corroborate the need and request for a 2nd passport. If you haven’t made your reservations yet please let us know.</p>
							<a class="offer-visa" href="#">DO YOU NEED A VISA TO TRAVEL TO YOUR DESTINATION?</a>
						</div>
					</div>
					</div>
				</div>
			   <button type="button" id="second-additiaonal" class="btn email-requirements" data-toggle="modal" data-target="#emailRequirements">
						email requirments
						</button>
				<a class="print-requirements" href="<?php echo base_url('requirements/State-Dept-Form-2nd-Passport-2024-for-website.pdf');?>" target="_blank">print requirements</a>
					<div id="myModal" class="modal">
						...
						<div class="modal-content">
							...
							<p class="tag-line">Get all requirements through email!</p>
							<div class="email-field">
								<input placeholder="Your Email" id="email" type="email">
								<a href="javascript:void(0);" id="second-additiaonal_btn">Send</a>
							</div>
...
<script>
	jQuery('#second-additiaonal_btn').click(function (e) {
		e.preventDefault();
		...
		$.ajax({
			url: '<?php echo base_url('send-email-additional');?>',
			method: 'post',
...
<script>
	$(document).ready(function(){
		...
		$("#second-additiaonal").click(function(){
