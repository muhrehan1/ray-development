...
<section class="inner-banner package-banner" style=" background: url(<?php echo base_url(); ?>/assets/front/images/Additional_Passport_Header.jpg); ">
        <div class="container">
            <div class="row">
                <div class="col-12 col-md-12 col-sm-12 col-lg-12 col-xl-12 col-xxl-12">
                    <h2>New Passport Services</h2>
                </div>
            </div>
        </div>
        <div class="packages">
            <div class="container">
                <div class="row ">
							<?php
							foreach($new_passports_packages as $key => $new_passports_package):
							?>
                        <div class="col-12 col-md-12 col-sm-12 col-lg-3 col-xl-3 col-xxl-3">
                            <div class="passport-package">
                                <h4><?php echo $new_passports_package->plan_name ; ?></h4>
                                <h6><?php echo $new_passports_package->plan_processing_time;?></h6>
                                <p>Processing Weeks</p>
                            
								<form id="order-process" action="<?php echo base_url('checkout-process')?>" method="post">
									<input type="hidden" name="order_id" value="<?php echo $new_passports_package->plans_id;?>">
									<input type="hidden" name="action" value="add">
									<input type="submit" class="submit-order" value="Order now">
								</form>
								
                                <h3><?php  $price = number_format( $new_passports_package->plan_price, 2 ); echo '$'.$price ;?></h3>
                                <p>Service Fee</p>
                            </div>
                        </div>
						<?php endforeach ;?>
                    ...
                    <div class="slider-of-info">
                        ...
                        <div>
                            <div class="slider-box">
                                ...
                                <div class="slider-box-content">
                                    <p><a href="javascript:;" class="hyperlink pdf" data-link="doc/LOA_new_RJR.pdf">download</a> complete but <strong>DO NOT SIGN</strong> the <a href="javascript:;" class="hyperlink" data-link="https://pptform.state.gov/?Submit2=Complete+Online+%26+Print">DS-11</a> US Passport Application.</p>
                        ...
                        <div>
                            <div class="slider-box">
                                ...
                                <div class="slider-box-content">
                                    <p><a href="javascript:;" class="hyperlink" data-link="https://travel.state.gov/content/travel/en/passports/how-apply/identification.html">Submit ONE</a> of the following</p>
                                    <ul>
                      ...
                      <button type="button" id="myBtn" class="btn email-requirements" data-toggle="modal" data-target="#myModal">
						email requirements
						</button>
                    <a class="print-requirements" href="<?php echo base_url('requirements/3eb529e0ff25be3c4fa3622d566d07f6.pdf
					...
					<div id="myModal" class="modal">
						...
						<div class="modal-content">
							...
							<div class="email-field">
								...
								<a href="javascript:void(0);" id="get_email_new_passport">Send</a>
							</div>
                ...
                <div class="simple-process-content">
                    ...
                    <div class="row">
                        <div class="col-xxl-3 col-xl-3 col-lg-6 col-md-6 col-sm-12 col-12">
                            <div class="card-process">
                                <div class="img-process">
                                    <img class="img-fluid w-100" src="https://staging.designinternal.com/dev/ray-development/assets/front/images/passport-process-1.png">
                                </div>
                        ...
                        <div class="col-xxl-3 col-xl-3 col-lg-6 col-md-6 col-sm-12 col-12">
                            <div class="card-process">
                                <div class="img-process">
                                    <img class="img-fluid w-100" src="https://staging.designinternal.com/dev/ray-development/assets/front/images/passport-process-2.png">
                                </div>
                                <div class="content-process">
                        ...
                        <div class="col-xxl-3 col-xl-3 col-lg-6 col-md-6 col-sm-12 col-12">
                            <div class="card-process">
                                <div class="img-process">
                                    <img class="img-fluid w-100" src="https://staging.designinternal.com/dev/ray-development/assets/front/images/passport-process-3.png">
                                </div>
                                <div class="content-process">
                        ...
                        <div class="col-xxl-3 col-xl-3 col-lg-6 col-md-6 col-sm-12 col-12">
                            <div class="card-process">
                                <div class="img-process">
                                    <img class="img-fluid w-100" src="https://staging.designinternal.com/dev/ray-development/assets/front/images/passport-process-4.png">
                                </div>
                                <div class="content-process">
...
<script>
	jQuery('#get_email_new_passport').click(function (e) {
		e.preventDefault();
		...
		$.ajax({
			url: '<?php echo base_url('send-email-new-passport');?>',
			method: 'post',
